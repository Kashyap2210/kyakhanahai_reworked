...
export default function Footer() {
  return (
    <div className="border-t border-gray-500 h-20 bg-bg-red z-9999 text-font-yellow flex flex-col justify-center items-center transition-all duration-150 w-full  opacity-100  ">
